                    ...
                    blocksDescriptions: [
...

                        {
                            ...
                            description: `<ul>
									...
									<li>- Максимальный вес материалов 2мб.</li>
								</ul>`,
                        },
                    ...
                    blocksDescriptions: [
                        {
                            subtitle: "",
                            description:
                                "HobJob работает по системе подписки. Каждый месяц 30% от общей прибыли отправляется на выплаты мастерам. Мастер получает оплату из этого фонда за минуты просмотра своего курса. Например, если просмотр ваших курсов составляет 5% от общего числа просмотренных минут, то вы получаете 5% от зарплатного фонда.",
                        },
                    ],
                },
