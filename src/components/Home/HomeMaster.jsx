                            ...
                            <div className="main-master-payment-content">
                                <div className="main-master-payment-content-descriptions">
                                    <p className="main-master-payment-content-descriptions__description">
                                        Я получаю с разовой продажи курса 30%
                                        после вычета налогов и комиссии
                                        платёжной системы, а если рекомендую
                                        курс своим подписчикам, то получаю не
                                        30%, а 50% от стоимости курса.
                                    </p>
                                    <p className="main-master-payment-content-descriptions__description">
                                        Если человек купил подписку по моей
                                        рекомендации, то я сразу получаю
                                        фиксированную выплату в 400 рублей.
                                    </p>
                                    <p className="main-master-payment-content-descriptions__description">
                                        Также у HobJob довольно интересная
                                        система распределения прибыли с подписки
                                        одного человека. Во-первых, платформа
                                        также работает и по системе подписки, я
                                        буду получать прибыль с человека, пока
                                        он не отпишется или не перестанет
                                        смотреть мой курс.
                                    </p>
                                    <p className="main-master-payment-content-descriptions__description">
                                        ...
                                        делиться между вами двумя в зависимости
                                        от количества минут, проведённых
                                        человеком на вашем курсе.
                                    </p>
                                    <p className="main-master-payment-content-descriptions__description">
                                    ...
                                    <p className="main-master-payment-content-descriptions__description">
                                        И вот месяц подошел к концу, а мне на
