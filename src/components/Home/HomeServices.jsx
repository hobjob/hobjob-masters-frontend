                  ...
                  <div className="main-services-items-wrapper">
                      ...
                      <div className="main-services-item">
                          ...
                          <p className="main-services-item__description">
                              ...
                              команды рассказали, как снимать, где снимать, что
                              снимать, чем снимать и как монтировать.
                              <br />
                      ...
                      <div className="main-services-item">
                          ...
                          <p className="main-services-item__description">
                              Команда HobJob занимается рекламой всех курсов на
                              платформе. Вам не нужно за неё платить. Также ваш
                              курс будет продвигаться внутри платформы среди её
                              пользователей.
                          </p>
                      </div>
                  </div>
